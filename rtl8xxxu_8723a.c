...
static int rtl8723au_init_phy_rf(struct rtl8xxxu_priv *priv)
{
	...
	/* Reduce 80M spur */
	priv->intfops->write32(priv, REG_AFE_XTAL_CTRL, 0x0381808d);
	priv->intfops->write32(priv, REG_AFE_PLL_CTRL, 0xf0ffff83);
	priv->intfops->write32(priv, REG_AFE_PLL_CTRL, 0xf0ffff82);
	priv->intfops->write32(priv, REG_AFE_PLL_CTRL, 0xf0ffff83);
...
static int rtl8723au_power_on(struct rtl8xxxu_priv *priv)
{
	...
	val32 |= (0x06 << 28);
	priv->intfops->write32(priv, REG_EFUSE_CTRL, val32);
exit:
	return ret;
}
